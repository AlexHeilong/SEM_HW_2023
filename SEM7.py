...
vovel = ['а', 'е', 'ё', 'и', 'о', 'у', 'ы', 'э', 'ю', 'я']
poem = input('Введите кричалку: ')
# print(poem)
phrase = list(poem.lower().split(' '))
# print(phrase)
count = 0
for i in phrase:
    for j in i:
...
def print_operation_table(func, num_rows, num_сolumns):
    my_list = [[func(i, j) for i in range(1, num_rows+1)] for j in range(1, num_сolumns+1)]
    for i in my_list:
        result = [j for j in i]
        print(result)
    return result
